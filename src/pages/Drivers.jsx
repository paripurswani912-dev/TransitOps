  ...
  return (
    <div className="space-y-6 relative h-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-100 tracking-tight font-sans">Drivers & Safety Profiles</h2>
          <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Monitor licensing credentials, safety ratings, and active duty assignments.</p>
        </div>
      ...
      <div className="bg-gray-50/60 dark:bg-slate-800/40 p-3 rounded-xl border border-gray-150 dark:border-slate-800">
        ...
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-855 py-2 pl-10 pr-4 text-sm text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-gray-500 outline-none transition-all focus:border-amber-500 focus:ring-2 focus:ring-amber-500/10 font-sans"
          />
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm text-center px-4">
          ...
          <h3 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-1 font-sans">No drivers registered yet</h3>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-800">
              <thead className="bg-gray-50 dark:bg-slate-800/40">
                <tr>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono">Driver</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono">License No.</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono">Category</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono">Expiry</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono">Contact</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono text-center">Trip Compl.</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono text-center">Safety Score</th>
                  ...
                  <th scope="col" className="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 font-mono">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 dark:divide-slate-800 text-sm font-sans">
                {filteredDrivers.map((d) => (
                  ...
                  >
                    {/* Driver Name in Bold */}
                    <td className="px-6 py-4 font-semibold text-gray-900 dark:text-slate-100 whitespace-nowrap">{d.name}</td>

                    {/* License No in JetBrains Mono */}
                    <td className="px-6 py-4 font-mono font-medium text-gray-700 dark:text-slate-350 whitespace-nowrap">{d.licenseNo}</td>

                    {/* Category */}
                    <td className="px-6 py-4 text-gray-600 dark:text-slate-300 whitespace-nowrap">{d.licenseCategory}</td>

                    {/* Expiry (Formatted and styled if expired) */}
                    <td className="px-6 py-4 whitespace-nowrap text-gray-800 dark:text-slate-200">{renderExpiry(d.licenseExpiry)}</td>

                    {/* Contact details */}
                    <td className="px-6 py-4 font-mono text-gray-600 dark:text-slate-400 whitespace-nowrap">{d.contact}</td>

                    {/* Trip Completion percentage */}
                    <td className="px-6 py-4 whitespace-nowrap text-center font-mono font-medium text-gray-700 dark:text-slate-300">
            ...
            <form onSubmit={handleSave} className="flex-1 overflow-y-auto px-6 py-5 space-y-4 font-sans">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-855 py-2.5 px-3 text-sm text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-gray-500 outline-none transition-all focus:border-amber-500 focus:ring-2 focus:ring-amber-500/10 font-mono uppercase"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-855 py-2.5 px-3 text-sm text-gray-900 dark:text-slate-200 outline-none transition-all focus:border-amber-500 focus:ring-2 focus:ring-amber-500/10"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-855 py-2.5 px-3 text-sm text-gray-900 dark:text-slate-100 outline-none transition-all focus:border-amber-500 focus:ring-2 focus:ring-amber-500/10 font-mono"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-855 py-2.5 px-3 text-sm text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-gray-500 outline-none transition-all focus:border-amber-500 focus:ring-2 focus:ring-amber-500/10 font-mono"
                />
              </div>
